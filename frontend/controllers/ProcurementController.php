...
class ProcurementController extends Controller
{
    ...
    public function actionList(){
        ...
        $service = Yii::$app->params['ServiceName']['SupplierApplicationList'];
        $filter = [
        ...
        foreach($results as $item){
            ...
            $ViewLink = Html::a('<i class="fas fa-eye"></i>',['view','Key'=> $item->Key ],['title' => 'View Vendor Card..','class'=>'btn btn-outline-primary btn-xs']);
           // $updateLink = Html::a('<i class="fas fa-pen"></i>',['update','No'=> $item->Appraisal_Code ],['title' => 'Update Vendor Card.','class'=>'btn btn-outline-primary btn-xs']);
