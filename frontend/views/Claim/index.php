    ...
    <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Mileage and Subsistence Applications List</h3>
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            columns: [
                ...
                { title: 'Total Imprest Amount' ,data: 'Total_Imprest_Amount'},
                               
                { title: 'Payment Voucher No.' ,data: 'Payment_Voucher_No'},
