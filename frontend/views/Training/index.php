    ...
    <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Training Applications List</h3>
            </div>
            <div class="card-body">
               
                    <table class="table table-bordered table-hover w-100" id="table" style="width: 100%">
                    </table>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'training/list',
            paging: true,
            columns: [
                { title: 'No' ,data: 'No'},
                { title: 'Training_Area' ,data: 'Training_Area'},
                { title: 'Training_Program' ,data: 'Training_Program'},
