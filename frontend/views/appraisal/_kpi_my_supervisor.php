            ...
            <table class="table table-hover table-borderless table-info">
                <thead>
                    <tr>
                        ...
                        <td class="text text-bold text-center text-info">Mid_Year Supervisor Assesment</td>
                        <td class="text text-bold text-center text-info">Mid_Year Supervisor Comments</td>
