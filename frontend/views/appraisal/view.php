    ...
    <div class="col-md-12">
                        ...
                        <tbody>
                            <?php foreach($card->Employee_Appraisal_KRAs->Employee_Appraisal_KRAs as $k){ ?>
                                ...
                                <tr class="parent">
                                    ...
                                    <td><?= Html::a('Evaluate',['appraisalkra/update','Line_No'=> $k->Line_No,'Appraisal_No' => $k->Appraisal_No,'Employee_No' => $k->Employee_No ],['class' => ' evalkra btn btn-outline-warning btn-xs'])?></td>
                                </tr>
                                <tr class="child">
                                    <td colspan="11" >
        ...
        <div class="card-success">
            <div class="card-header">
                ...
                <?= Html::a('<i class="fas fa-plus"></i> Add New',['training-plan/create','Appraisal_No'=> $model->Appraisal_No,'Employee_No' => $model->Employee_No],['class' => 'btn btn-xs btn-outline-warning add-trainingplan']) ?>
            </div>
            <div class="card-body">
                <table class="table table-bordered">
                    <thead>
                                            ...
                                            foreach($model->getAppraisalbehaviours($comp->Line_No) as $be):  ?>
                                                <tr>
                                                   ...
                                                   <!-- <td><?/*= $be->Appraisal_Code */?></td>-->
                                                    ...
                                                    <td><?= Html::a('Evaluate',['employeeappraisalbehaviour/update','Employee_No'=>$be->Employee_No,'Line_No'=> $be->Line_No,'Appraisal_No' => $be->Appraisal_Code ],['class' => ' evalbehaviour btn btn-outline-warning btn-xs'])?></td>
                                                </tr>
                                                <?php
                                            endforeach;
                                        }
...
<?php if($model->EY_Appraisal_Status !== 'Agreement_Level'){ ?>
        ...
        <div class="card-success">
            <div class="card-header">
                ...
                <?= Html::a('<i class="fas fa-plus"></i> Add New',['learningassessment/create','Appraisal_No'=> $model->Appraisal_No,'Employee_No' => $model->Employee_No],['class' => 'btn btn-xs btn-outline-warning add-learning-assessment']) ?>
    ...
    <div class="card-success">
        <div class="card-header">
            ...
            <?= Html::a('<i class="fas fa-plus"></i> Add New',['careerdevelopmentplan/create','Appraisal_No'=> $model->Appraisal_No,'Employee_No' =>$model->Employee_No ],
                [
                    'class' => 'btn btn-xs btn-outline-warning add-cdp',
                    ...
                    <?php foreach($card->Career_Development_Plan->Career_Development_Plan as $cdp){ ?>
                        <tr class="parent">
                            ...
                            <td>
                                ...
                                <?= Html::a('<i class="fas fa-plus-square"></i> ',['careerdevelopmentplan/create','Goal_Line_No'=> $cdp->Line_No,'Appraisal_No'=> $model->Appraisal_No,'Employee_No' => $model->Employee_No],['class' => 'btn btn-xs btn-outline-primary add-cds', 'title'=>'Add Career Development Strength']) ?>
                            </td>
                        </tr>
                                    ...
                                    <?php if(is_array($model->getCareerdevelopmentstrengths($cdp->Line_No))){
                                        ...
                                        foreach($model->getCareerdevelopmentstrengths($cdp->Line_No) as $cds):  ?>
                                            <tr>
                                                ...
                                                <td><?= $cds->Strength ?></td>
                                                <td>
                                                    <?= Html::a('<i class="fas fa-edit"></i> ',['careerdevelopmentstrength/update','Line_No'=> $cdp->Line_No,'Appraisal_No'=> $model->Appraisal_No,'Employee_No' => $model->Employee_No],['class' => 'btn btn-xs btn-outline-primary update-learning']) ?>
    ...
    <div class="card-success">
        <div class="card-header">
            ...
            <?= Html::a('<i class="fas fa-plus"></i> Add New',['furtherdevelopmentarea/create','Appraisal_No'=> $model->Appraisal_No,'Employee_No' => $model->Employee_No],['class' => 'btn btn-xs btn-outline-warning add-fda']) ?>
                    ...
                    <?php foreach($card->Areas_of_Further_Development->Areas_of_Further_Development as $fda){ ?>
                        <tr class="parent">
                            ...
                            <td>
                                ...
                                <?= Html::a('<i class="fas fa-plus-square"></i> ',['furtherdevelopmentarea/create','Wekaness_Line_No'=> $fda->Line_No,'Appraisal_No'=> $model->Appraisal_No,'Employee_No' => $model->Employee_No],['class' => 'btn btn-xs btn-outline-primary add-wdp','Add a Weakness Development Plan.']) ?>
                            </td>
                        </tr>
                        <!--Start displaying children-->
                        <tr class="child">
