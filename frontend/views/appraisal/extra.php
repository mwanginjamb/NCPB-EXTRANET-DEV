...
$this->title = Yii::$app->params['generalTitle'].' Extra Supervisor Appraisals';
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Extra Supervisor Appraisal List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'appraisal/extrasupervisorlist',
            paging: true,
            columns: [
                { title: 'No' ,data: 'No'},
