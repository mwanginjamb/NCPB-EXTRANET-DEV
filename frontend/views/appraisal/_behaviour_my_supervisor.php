        ...
        <table class="table table-hover table-borderless table-info">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text text-bold text-center text-info"><b>M.Yr Supervisor Rating</b></td>
                    <td class="text text-bold text-center text-info"><b>M.Yr Supervisor Comments</b></td>
                ...
                <?php if (is_array($model->getAppraisalbehaviours($comp->Line_No))) {
                    ...
                    foreach ($model->getAppraisalbehaviours($comp->Line_No) as $be) :  ?>
                        <tr>
                            ...
                            <td data-key="<?= $be->Key ?>" data-name="Mid_Year_Supervisor_Rating" data-service="EmployeeAppraisalBehaviours" ondblclick="addDropDown(this,'ratings')"><?= !empty($be->Mid_Year_Supervisor_Rating) ? $be->Mid_Year_Supervisor_Rating : '' ?></td>
                            <td data-key="<?= $be->Key ?>" data-name="Mid_Year_Supervisor_Comments" data-service="EmployeeAppraisalBehaviours" ondblclick="addTextarea(this)"><?= !empty($be->Mid_Year_Supervisor_Comments) ? $be->Mid_Year_Supervisor_Comments : '' ?></td>
