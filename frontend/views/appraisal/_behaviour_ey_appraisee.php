        ...
        <table class="table table-hover table-borderless table-info">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text text-bold text-center text-info"><b>Self Rating</b></td>
                    <td class="text text-bold text-center text-info"><b>Appraisee Remark</b></td>
                ...
                <?php if (is_array($model->getAppraisalbehaviours($comp->Line_No))) {
                    ...
                    foreach ($model->getAppraisalbehaviours($comp->Line_No) as $be) :  ?>
                        <tr>
                            ...
                            <td data-key="<?= $be->Key ?>" data-name="Self_Rating" data-service="EmployeeAppraisalBehaviours" ondblclick="addDropDown(this,'ratings')"><?= !empty($be->Self_Rating) ? $be->Self_Rating : '' ?></td>
                            <td data-key="<?= $be->Key ?>" data-name="Appraisee_Remark" data-service="EmployeeAppraisalBehaviours" ondblclick="addTextarea(this)"><?= !empty($be->Appraisee_Remark) ? $be->Appraisee_Remark : '' ?></td>
