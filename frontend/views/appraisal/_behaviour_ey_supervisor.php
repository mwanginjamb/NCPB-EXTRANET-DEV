        ...
        <table class="table table-hover table-borderless table-info">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text text-bold text-center"><b>Self Rating</b></td>
                    <td class="text text-bold text-center"><b>Appraisee Remark</b></td>
                    <td class="text text-bold text-center text-info"><b>Appraiser Rating</b></td>




                    <td class="text text-bold text-center text-info"><b>Overall Remarks</b></td>
                    <td><b>Agree</b></td>
                ...
                <?php if (is_array($model->getAppraisalbehaviours($comp->Line_No))) {
                    ...
                    foreach ($model->getAppraisalbehaviours($comp->Line_No) as $be) :  ?>
                        <tr>
                            ...
                            <td data-key="<?= $be->Key ?>" data-name="Appraiser_Rating" data-service="EmployeeAppraisalBehaviours" ondblclick="addDropDown(this,'ratings')"><?= !empty($be->Appraiser_Rating) ? $be->Appraiser_Rating : '' ?></td>


                            <td data-key="<?= $be->Key ?>" data-name="Overall_Remarks" data-service="EmployeeAppraisalBehaviours" ondblclick="addTextarea(this)"><?= !empty($be->Overall_Remarks) ? $be->Overall_Remarks : '' ?></td>
