            ...
            <table class="table table-hover table-borderless table-info">
                <thead>
                    <tr>
                        ...
                        <td class="text text-bold text-center text-info">Appraisee Self_Rating</td>
                        <td class="text text-bold text-center text-info">Employee Comments</td>
                        ...
                        <td class="text text-bold text-center text-info">Target Status</td>
                        <td class="text text-bold text-center text-info">Non-Achievement Reasons</td>
