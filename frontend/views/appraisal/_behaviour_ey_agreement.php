        ...
        <table class="table table-hover table-borderless table-info">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text text-bold text-center text-info"><b>Agree</b></td>
                    <td class="text text-bold text-center text-info"><b>Disagrement Reason</b></td>
                ...
                <?php if (is_array($model->getAppraisalbehaviours($comp->Line_No))) {
                    ...
                    foreach ($model->getAppraisalbehaviours($comp->Line_No) as $be) :  ?>
                        <tr>
                            ...
                            <td data-key="<?= $be->Key ?>" data-name="Agree" data-service="EmployeeAppraisalBehaviours" ondblclick="addInput(this,'checkbox')"><?= ($be->Agree) ? 'Yes' : 'No' ?></td>
                            <td data-key="<?= $be->Key ?>" data-name="Disagreement_Comments" data-service="EmployeeAppraisalBehaviours" ondblclick="addTextarea(this)"><?= !empty($be->Disagreement_Comments) ? $be->Disagreement_Comments : '' ?></td>
                        </tr>
                <?php
                    endforeach;
                }
