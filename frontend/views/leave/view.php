...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">   <?= Html::a('<i class="fa fa-plus-square"></i> New Line',['leaveline/create','Request_No'=>$model->Application_No],['class' => 'add-objective btn btn-outline-info']) ?></div>
                </div>
